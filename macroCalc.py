...
print("Please enter your ingredients one at a time along with the ammount in grams. Enter nothing and press return twice when finished")
ingredients = []
meal = []
try:
    ...
    meal.append(['Totals', totalCals, totalFats, totalCarbs, totalProtein])
    
    mealDF = pd.DataFrame(meal, columns = ['Ingredient', 'Calories', 'Fats', 'Carbs', 'Protein'])
